...
import ma.formation.ioc.service.IService;
import ma.formation.ioc.service.ServiceImpl;
...
public class TestService {
    ...
    void test1() {
        ...
        () -> Assertions.assertEquals("PC HP I7", service.findById(1L).getDescription(),
                ...
                () -> Assertions.assertEquals(25000d, service.findById(1L).getPrice(),
                        "First article price is not correct"),
        () -> Assertions.assertEquals(5d, service.findById(1L).getQuantity(),
